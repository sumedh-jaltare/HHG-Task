    ...
    <div className="space-y-4 rounded-2xl border border-hh-cream/15 bg-hh-green-700/40 p-4">
      ...
      <label className="block space-y-1.5">
        ...
        <input
          ...
          value={details.role}
          maxLength={24}
          placeholder="e.g. Frontend Engineer, Solidity, Design"
      ...
      <div className="space-y-1.5">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
          <p className="min-h-[2.6rem] flex-1 rounded-xl border-2 border-hh-pink/40 bg-hh-green-900 px-3 py-2.5 font-mono text-sm text-hh-cream">
            {details.title || "Hit generate after you add a name"}
          </p>
          <button
            type="button"
            onClick={() =>
